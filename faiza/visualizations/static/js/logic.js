...
function createFeatures(earthquakeData) {
  ...
  // Create a GeoJSON layer that contains the features array on the GDPData object.
  // Run the onEachFeature function once for each piece of data in the array.
  var gdp_data = L.geoJSON(samples.json, {
    onEachFeature: onEachFeature
  });
...
//Create our map, giving the current GDP for every country.